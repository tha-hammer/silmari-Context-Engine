...
### Success Criteria
**Automated:**
- [x] Test fails for right reason (Red): `python -m pytest planning_pipeline/tests/test_orchestrator.py::TestCLIArgumentParsing -v`
- [x] Test passes (Green): `python -m pytest planning_pipeline/tests/test_orchestrator.py::TestCLIArgumentParsing -v`
- [x] All tests pass after refactor: `python -m pytest planning_pipeline/tests/ -v -m "not slow"`
...
**Automated:**
- [x] Test fails for right reason (Red)
- [x] Test passes (Green): `python -m pytest planning_pipeline/tests/test_orchestrator.py::TestPipelineExecution -v`
- [x] All tests pass after refactor
...
**Automated:**
- [x] Test fails for right reason (Red)
- [x] Test passes (Green): `python -m pytest planning_pipeline/tests/test_orchestrator.py -v`
- [x] All tests pass: `python -m pytest planning_pipeline/tests/ -v`

**Manual:**
- [x] `python planning_orchestrator.py --help` shows usage
