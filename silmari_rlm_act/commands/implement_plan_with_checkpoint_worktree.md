...
You are tasked with implementing an approved technical plan from `thoughts/searchable/plans/` in a dedicated worktree. These plans contain phases with specific changes and success criteria.
