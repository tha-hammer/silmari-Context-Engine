...
**CRITICAL**: Always use the project path above ({project_path}) when reading files or navigating the codebase. Never hallucinate or guess file paths.
...
8. **Sync and present findings:**
   ...
   - Do NOT ask follow-up questions - the pipeline will handle next steps
