...
- Always use ONLY the relative path starting with `thoughts/searchable/...` without any directory prefix
- Example: `thoughts/searchable/plans/fix-mcp-keepalive-proper.md` (not the full absolute path)
