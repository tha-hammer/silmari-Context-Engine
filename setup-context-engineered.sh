...
❌ Wrong:
```
Current time: 2024-01-15T14:32:15Z  # Changes every call!
...
After implementing a feature, use these subagents:
...
4. **RUN TESTS** - no exceptions
5. **USE SUBAGENTS** - code-reviewer, test-runner, feature-verifier
6. Capture feedback for context evolution
